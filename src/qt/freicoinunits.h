...
/** Gencoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for dropdown selection boxes.
*/
class GencoinUnits: public QAbstractListModel
{
public:
    explicit GencoinUnits(QObject *parent);
...
typedef GencoinUnits::Unit GencoinUnit;
